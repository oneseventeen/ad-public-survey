...
return [
    ...
    */
    ...
    'default' => env('WRITEDOWN_PARSER', 'parsedownextra'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option specifies if you want Writedown to intergrate markdown views
    | that will be automatically parsed and rendered as html. The following
    | view extensions will become available and rendable, if set to true:
    ...
    */
    ...
    | use for your appplication. You may configure and extend your choosen
